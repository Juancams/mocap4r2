...
class MocapSystem1 : public mocap4r2_control::ControlledLifecycleNode
{
public:
  ...
  mocap4r2_control_msgs::msg::Control last_msg_;
...
{
  auto node_1 = std::make_shared<MocapSystem1>("mocap4r2_system_1");
  auto node_2 = std::make_shared<MocapSystem1>("mocap4r2_system_2");
  auto control_node = std::make_shared<mocap4r2_control::ControllerNode>();

  std::vector<mocap4r2_control_msgs::msg::MocapInfo> env_infos;
  auto env_sub = control_node->create_subscription<mocap4r2_control_msgs::msg::MocapInfo>(
    "mocap4r2_environment",
    rclcpp::QoS(1000).reliable().transient_local().keep_all(),
    [&env_infos](const mocap4r2_control_msgs::msg::MocapInfo::SharedPtr msg) {
  ...
  ASSERT_TRUE(
    env_infos[0].mocap4r2_source == "mocap4r2_system_1" ||
    env_infos[0].mocap4r2_source == "mocap4r2_system_2");
  ASSERT_TRUE(
    env_infos[1].mocap4r2_source == "mocap4r2_system_1" ||
    env_infos[1].mocap4r2_source == "mocap4r2_system_2");
  ...
  control_node->start_system("session_2", {"mocap4r2_system_1"});
  ...
  std::vector<mocap4r2_control_msgs::msg::MocapInfo> env_infos_late;
  auto env_sub_late = control_node->create_subscription<mocap4r2_control_msgs::msg::MocapInfo>(
    "mocap4r2_environment",
    rclcpp::QoS(1000).reliable().transient_local().keep_all(),
    [&env_infos_late](const mocap4r2_control_msgs::msg::MocapInfo::SharedPtr msg) {
  ...
  ASSERT_TRUE(
    env_infos_late[0].mocap4r2_source == "mocap4r2_system_1" ||
    env_infos_late[0].mocap4r2_source == "mocap4r2_system_2");
  ASSERT_TRUE(
    env_infos_late[1].mocap4r2_source == "mocap4r2_system_1" ||
    env_infos_late[1].mocap4r2_source == "mocap4r2_system_2");
